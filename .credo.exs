...
# Credo configuration for HAR (Hybrid Automation Router)
#
# Run `mix credo --help` for details on how to use Credo.
%{
  configs: [
    %{
      name: "default",
      ...
      checks: %{
        enabled: [
          ...
          # Readability checks - disable strict alias ordering for now
          ...
          # Refactoring checks - lower priority for some
        ...
        disabled: [
          # Disable these for alpha phase - will enable as project matures
