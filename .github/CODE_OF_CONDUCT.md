...
Replace all REMOVED values:
  hybrid-automation-router     - Your project name
  hyperpolymath            - GitHub/GitLab username or org
  hybrid-automation-router             - Repository name
  conduct@example.com    - Email for conduct reports
...
We as members, contributors, and leaders pledge to make participation in hybrid-automation-router a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
|--------|---------|----------|
| **Email** | conduct@example.com | Detailed reports, sensitive matters |
...
2. **Email** conduct@example.com with subject line "Appeal: [Original Report ID]"
...
- Open a [Discussion](https://github.com/hyperpolymath/hybrid-automation-router/discussions) (for general questions)
- Email conduct@example.com (for private questions)
