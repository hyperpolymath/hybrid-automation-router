...
This document describes the governance model for **hybrid-automation-router**.

---

## Project Governance Model

hybrid-automation-router follows a **Benevolent Dictator For Life (BDFL)** governance model.
