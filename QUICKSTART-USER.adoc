...
// Replace hybrid-automation-router, Hybrid Automation Router — See README.adoc for details., just run, Hybrid Automation Router started successfully. with actuals
= hybrid-automation-router — Quick Start for Users
:toc:
:toclevels: 2

== What is hybrid-automation-router?

Hybrid Automation Router — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./hybrid-automation-router-portable
----
...
[source]
----
Hybrid Automation Router started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/hybrid-automation-router/wiki
