...
strategies. The v0.2.0 workspace provides 8 crates covering core
...
- **proven-fsm types** — same state machine vocabulary for workflow
  transitions
...
- `har-dashboard/panel.json` — Main overview (targets, strategies,
  events)

- `rpa-elysium/panel.json` — RPA Elysium target status, workflows,
  events

# License

Palimpsest License (MPL-2.0) 2026 Jonathan D.A. Jewell
